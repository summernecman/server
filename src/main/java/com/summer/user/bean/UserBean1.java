 ...
 */
public class UserBean1 extends BaseBean {
    ...
    private ArrayList<UserBean1> contacts;
    ...
    public ArrayList<UserBean1> getContacts() {
        return contacts;
    }

    public void setContacts(ArrayList<UserBean1> contacts) {
